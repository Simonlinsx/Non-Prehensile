...
class NonPrehensileEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Training-only episode/contact statistics. Physics and managers still step
    # when disabled; external controllers must perform their own acceptance audit.
...
class NonPrehensileEnv(ManagerBasedRLEnv):
    ...
    def step(self, action):
        ...
        if not self.cfg.enable_training_metrics:
